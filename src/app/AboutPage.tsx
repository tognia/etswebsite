        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-24">
          ...
          <div className="lg:col-span-7 space-y-6 text-gray-700 text-lg leading-relaxed">
            ...
            <p>
              ...
              d'envergure nationale et internationale. Notre savoir-faire
              englobe la construction d'infrastructures publiques complexes, la
              rénovation lourde de laboratoires scientifiques de pointe à haute
              bio-sécurité, ainsi que l'édification de monuments architecturaux
              institutionnels.
            </p>
            <p>
              Grâce à une synergie performante avec des organismes de
              financement internationaux (tels que l'USAID ou le USA-CDC) et des
              cabinets de contrôle rigoureux, nous apportons des réponses
              concrètes, durables et sur-mesure aux défis infrastructurels des
          ...
          <div className="lg:col-span-5 bg-brand-black text-white p-8 border border-white/10 relative shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed italic">
                "Notre mission va bien au-delà de la simple manipulation du
                béton et de l'acier. Chez ETS N MOISE, chaque ouvrage est un
                engagement envers le développement du Cameroun, une signature de
                durabilité et une preuve de rigueur technique absolue."
              </p>
            </div>
          </div>
        </div>
