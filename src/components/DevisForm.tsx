  ...
  if (status === 'success') {
    return (
      ...
      >
        ...
        <h3 className="text-3xl font-black uppercase italic mb-4">Demande Envoyée</h3>
        <p className="text-gray-600 mb-8">
          Merci pour votre confiance. Notre équipe technique étudiera votre dossier et vous contactera sous 48h.
        </p>
        <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-gray-600 text-lg mb-12 leading-relaxed">
              ...
              Vous pouvez également joindre vos plans techniques pour une étude plus précise.
            </p>
            
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-brand-black text-white flex items-center justify-center font-bold shrink-0">01</div>
                <div>
                  <h4 className="font-bold uppercase mb-2">Étude de faisabilité</h4>
                  <p className="text-gray-500 text-sm">Analyse technique approfondie de vos besoins et contraintes.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-brand-black text-white flex items-center justify-center font-bold shrink-0">02</div>
                <div>
                  <h4 className="font-bold uppercase mb-2">Estimation budgétaire</h4>
                  <p className="text-gray-500 text-sm">Chiffrage précis et transparent des travaux à réaliser.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-brand-black text-white flex items-center justify-center font-bold shrink-0">03</div>
                <div>
                  <h4 className="font-bold uppercase mb-2">Planification</h4>
                  <p className="text-gray-500 text-sm">Établissement d'un calendrier prévisionnel rigoureux.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 md:p-12 shadow-2xl border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Type de Travaux</label>
                <select className="w-full px-4 py-3 bg-gray-50 border border-gray-200 focus:outline-none focus:border-brand-orange transition-colors appearance-none">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Budget Estimé (FCFA)</label>
                <input
                  type="text"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 focus:outline-none focus:border-brand-orange transition-colors"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Message / Détails</label>
                <textarea
                  rows={4}
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Plans Techniques (PDF, JPG)</label>
